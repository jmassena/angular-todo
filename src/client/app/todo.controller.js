...
module.exports = function(todoService, $log){
  ...
  var vm = this;
      ...
      // functions
      vm.getTodos = getTodos; // p: none
      vm.createTodo = createTodo; // p: none
      vm.updateDoneStatus = updateDoneStatus; // p: todoId
      vm.deleteTodo = deleteTodo; // p: todoId
      vm.submitTodo = submitTodo; // p:
